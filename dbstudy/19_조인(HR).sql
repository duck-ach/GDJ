...
-- DEPARTMENTS 테이블 : 부서위치를 의미하는 LOCATION_ID, DEPARTMENT_NAME
-- EMPLOYEES   테이블 : EMPLOYEE_ID, LAST_NAME
    SELECT E.EMPLOYEE_ID, E.LAST_NAME, D.DEPARTMENT_NAME
      FROM DEPARTMENTS D INNER JOIN EMPLOYEES E
        ON D.DEPARTMENT_ID = E.DEPARTMENT_ID        -- 조인조건
     WHERE LOCATION_ID = 1700;                      -- 일반조건
-- 조인조건이 없으면 CARTESIAN PRODUCT(CROSS JOIN)가 일어난다.

-- 조인조건을 넣지않고
    SELECT E.EMPLOYEE_ID, E.LAST_NAME, D.DEPARTMENT_NAME
      FROM DEPARTMENTS D, EMPLOYEES E
     WHERE D.DEPARTMENT_ID = E.DEPARTMENT_ID        -- 조인조건
       AND LOCATION_ID = 1700;                      -- 일반조건
...
SELECT E.EMPLOYEE_ID, E.LAST_NAME, D.DEPARTMENT_NAME, L.CITY, C.COUNTRY_NAME, E.DEPARTMENT_ID
  FROM DEPARTMENTS D INNER JOIN EMPLOYEES E
    ON D.DEPARTMENT_ID = E.DEPARTMENT_ID INNER JOIN LOCATIONS L
...
SELECT D.DEPARTMENT_ID, D.DEPARTMENT_NAME, NVL(COUNT(E.DEPARTMENT_ID), 0) AS 사원수
