...
//		int min = score[0];
		...
		Scanner sc = new Scanner(System.in);
		int pika = sc.nextInt();
		int pororo = sc.nextInt();
		int bread = sc.nextInt();
		
		
		sum = pika + pororo + bread;
		double avg = (double) sum / 3;
		System.out.println("평균 : " + avg + "점");
		
		if(pika > pororo && pororo > bread) {
			System.out.println("1등 : 피카츄");
			System.out.println("3등 : 브레드");
		} else if (pika > bread && bread > pororo) {
			System.out.println("1등 : 피카츄");
			System.out.println("3등 : 뽀로로");
		} else if (pororo > pika && pika > bread) {
			System.out.println("1등 : 뽀로로");
			System.out.println("3등 : 브레드");
		} else if (pororo > bread && bread > pika) {
			System.out.println("1등 : 뽀로로");
			System.out.println("3등 : 피카츄");
		} else if (bread > pika && pika > pororo) {
			System.out.println("1등 : 브레드");
			System.out.println("3등 : 뽀로로");
		} else {
			System.out.println("1등 : 브레드");
			System.out.println("3등 : 피카츄");
