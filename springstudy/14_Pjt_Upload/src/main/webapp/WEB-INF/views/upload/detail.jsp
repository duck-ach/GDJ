...
<script>
	...
	$(function(){
		...
		// 첨부 삭제
		$('.btn_attch_remove').click(function(){
	...
	<div>
		...
		<c:forEach items="${attachList}" var="attach">
			<div>
				...
				<input type="button" value="삭제" class="btn_attch_remove" data-upload_no="${upload.uploadNo}" data-attach_no="${attach.attachNo}"> <!-- button에 첨부 번호를 넣어준 것 / data속성을 넣어주고 꺼내서 사용 -->
			</div>
		</c:forEach>
	</div>
