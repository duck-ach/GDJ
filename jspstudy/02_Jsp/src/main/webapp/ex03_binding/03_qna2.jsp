...
<%
	...
	String createDate = request.getParameter("created_date");
	...
	// 파일명
	// 작성자IP_작성자.txt (정규식작성할때 콜론(:)은 정규식 예약어가 아니어서 역슬래시(\\)를 앞에 안붙여줘도된다.)
	...
	// 파일 경로
	String realPath = application.getRealPath("storage" + File.separator + createDate);
